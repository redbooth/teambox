...
module Paperclip
  ...
  class << self
    ...
    def load_error_messages
      if defined?(I18n)
        I18n.load_path << LOCALE_PATH if !I18n.load_path.include?(LOCALE_PATH)
        I18n.reload!
      else
  ...
  module ClassMethods
    ...
    def validates_attachment_presence name, options = {}
      message = options[:message] || :attachment_presence
    ...
    def validates_attachment_content_type name, options = {}
      message = options[:message] || :attachment_content_type_invalid
      attachment_definitions[name][:validations] << [:content_type, {:message      => message,
