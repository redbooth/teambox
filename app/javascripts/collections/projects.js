(function() {
  Teambox.Collections.Projects = Teambox.Collections.Base.extend({

    model: Teambox.Models.Project,
    ...
    organizations: function() {
      var self = this;
      var orgs = Teambox.my_projects.models.collect(function(p) {
        return p.get('organization');
      }).uniq();

      var projects = Teambox.my_projects.models.collect(function(p) {
