...
Feature: Preview
  ...
  Scenario: I compose a comment with line breaks
    ...
    And I fill in the comment box with line breaks
    And I press "Preview"
  ...
  Scenario: I compose a comment with underscored words, links and emails
    When I go to the page of the "Ruby Rockstars" project
    And I fill in the comment box with "Text _with_ an underscored_long_word and  a link like this one: http://teambox.com or an email like jordi@teambox.com"
    And I press "Preview"
